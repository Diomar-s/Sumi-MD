export async function before(m, { conn, participants, groupMetadata }) {
    ...
    const welcomeImage = 'https://files.catbox.moe/fdeur8.jpg'; // Imagen de bienvenida
    const goodbyeImage = 'https://files.catbox.moe/h0s885.jpg'; // Imagen de despedida
