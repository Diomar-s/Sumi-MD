...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `LEONEL`, dev, 'darel0954@gmail.com', `🇻🇪 Venezuela`, `${global.yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Una Bot 🍭`, `${packname}`, `📵 No Hacer Spam`, 'https://chat.whatsapp.com/IF8r9p5O5I0Idp2JSHiDRy', `Planeta 🌍`, `https://whatsapp.com/channel/0029Vagdmfv1SWt5nfdR4z3w`, biobot]
], m)
